...
// GL macros -- not all are used, but might as well include them all if we need them. May pare down eventually!
// Note-- these macros are (ideally) not included in the documentation as this leads to serious bloat.
#pragma region GL_DEFINES
/// @cond IGNORE
